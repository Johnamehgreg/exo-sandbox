...
const TransactionsBreakdowntable = () => {
  ...
  return (
    <Box className=" pt-4 pb-1 bg-white rounded-b-[8px] ">
          ...
          <thead className="uppercase w-full h-[40px] text-[10px] text-[#4B5563] ">
            <tr className="w-full text-left sticky top-0 bg-[#F9FAFB]  font-[400] ">
              <th className="pl-4 w-[20%]  ">
                <span className="flex items-center gap-1">DATE
  ...
  {transactions.map((transaction) => (
    <tr key={transaction.id} className="text-[12px] hover:bg-[#F3F4F6] ">
      ...
      <td className="p-4 border border-[#F3F4F6] font-[350]">-</td>
      ...
      <Box className="px-5 flex items-center justify-between bg-white py-2 border border-[#D1D5DB] rounded-[8px] mt-1 text-[14px] text-[#4B5563] ">
...
export default TransactionsBreakdowntable;
