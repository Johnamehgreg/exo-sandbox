...
const TransactionOverviewVolumeChart = ({ selectedOption }: Props) => {
  ...
  return (
    <VolumeChart {...{ isLoading, chartData, chartKey, series, options }} />
  );
};

export default TransactionOverviewVolumeChart;
